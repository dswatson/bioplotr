...
#' \href{http://s3.amazonaws.com/academia.edu.documents/31226205/nonlinearDimensionalityReductionByLocallyLinearEmbedding.pdf?AWSAccessKeyId=AKIAIWOWYYGZ2Y53UL3A&Expires=1498331730&Signature=DNS9d7%2FfBXp5uWPMPtr6gF2vq8A%3D&response-content-disposition=inline%3B%20filename%3DNonlinear_dimensionality_reduction_by_lo.pdf}{
#' Nonlinear Dimensionality Reduction by Locally Linear Embedding}. \emph{
