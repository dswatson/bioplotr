...
#' \href{https://genomebiology.biomedcentral.com/articles/10.1186/gb-2010-11-10-r106}{Differential
#' expression analysis for sequence count data}. \emph{Genome Biology}, 11:R106.
#'
#' Bullard, J.H., Purdom, E., Hansen, K.D. & Dudoit, S. (2010).
#' \href{http://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-11-94}{Evaluation
#' of statistical methods for normalization and differential expression in mRNA-Seq
#' experiments}. \emph{BMC Bioinformatics}, 11:94.
#'
#' Law, C.W., Alhamdoosh, M., Su, S., Smyth, G.K., & Ritchie, M.E. (2016).
#' \href{https://f1000research.com/articles/5-1408/v2}{RNA-seq analysis is easy as
#' 1-2-3 with limma, Glimma and edgeR}. \emph{F1000 Research, 5}(1408).
#'
...
#' \href{https://genomebiology.biomedcentral.com/articles/10.1186/gb-2010-11-3-r25}{A
#' scaling normalization method for differential expression analysis of RNA-seq data}.
