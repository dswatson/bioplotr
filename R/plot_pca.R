...
#'   collection of \code{\href{
#'   https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html}
#'   viridis} palettes, as well as all sequential color schemes available in 
#'   \code{RColorBrewer}. Alternatively, a character vector of colors 
#'   representing a smooth gradient, or a list of such vectors with length equal 
#'   to the number of continuous variables to visualize.
