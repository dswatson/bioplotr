...
#'   technical and/or biological covariates to test for associations with omic
#'   data.
...
#' tests (for continuous features) or one-way ANOVA \emph{F}-tests (for
...
#' with other features. For instance, biological covariates like sex and age are
#' usually nested within subject, while subject may be nested within other
#' features like batch or treatment group.
#'
#' @examples
#' library(edgeR)
#' data(airway)
